...
app.use('/customer', async (req, res) => {
    try {
        const dynamicUrl = `http://localhost:5075${req.originalUrl}`;
        console.log(`Redirecting to: ${dynamicUrl}`);
...
app.use('/inventory', async (req, res) => {
    try {
        const dynamicUrl = `http://localhost:5074${req.originalUrl}`;
        console.log(`Redirecting to: ${dynamicUrl}`);
...
app.use('/order', async (req, res) => {
    try {
        const dynamicUrl = `http://localhost:5078${req.originalUrl}`;
        console.log(`Redirecting to: ${dynamicUrl}`);
