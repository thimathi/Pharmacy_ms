    ...
    public void createUser(Context ctx) {
        ...
        if (request) {
            try{
                ...
                String sql = "INSERT INTO user_details (name, address, mobile, email, user_type) VALUES (?, ?, ?, ?, ?)";
    ...
    public void getUserById(Context ctx) {
        ...
        if (request) {
            try {
                ...
                String sql = "SELECT ud.id, ud.name, ud.address, ud.mobile, ud.email, ut.role " +
        ...
        try {
            ...
            try (Connection conn = Database.connect();
                ...
                if (rs.next()) {
                    ...
                    String token = TokenGenerator.generateToken(userType, email);
